            ...
            <div class="flex flex-wrap mb-24 -mx-3">
                <div class="w-full pr-2 lg:w-1/4 lg:block">
                                ...
                                <li class="mb-4" wire:key="{{ $item->id }}">
                                    <label for="{{ $item->slug }}" class="flex items-center dark:text-gray-400 ">
                                        <input type="checkbox" wire:model.live="selectedCategories"
                                            value="{{ $item->id }}" class="w-4 h-4 mr-2">
                        ...
                        <ul>
                            ...
                            <li class="mb-4">
                                <label for="onSale" class="flex items-center dark:text-gray-300">
                                    <input type="checkbox" wire:model.live='onSale' value="1" class="w-4 h-4 mr-2">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
                        <div>
                            <div class="font-s">{{ Number::currency($priceRange) }}</div>
                            <input type="range" wire:model.live='priceRange'
                                class="w-full h-1 mb-4  bg-blue-100 rounded appearance-none cursor-pointer"
                                max="5000" value="1000" step="10">
                            <div class="flex justify-between ">
                                <span
                                    class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(50) }}</span>
                                <span
                                    class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(5000) }}
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="w-full px-3 lg:w-3/4">
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between">
                                <select wire:model.live='sort'
                                    ...
                                    <option value="price_high">Sort by Price Higher</option>
                                    <option value="price_low">Sort by Price Lower</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-wrap items-center">
                        ...
                        @foreach ($models as $item)
                            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key='{{ $item->id }}'>
                                    ...
                                    <div class="relative bg-gray-200 ">
                                        <a href="{{ route('product.detail', $item->slug) }}" class=""
                                            ...
                                            <img src="{{ asset('storage/' . $item->images[0]) }}"
                                                alt="{{ $item->name }}"
                                                class="object-cover w-full m-4  h-56 mx-auto rounded-lg">
                                        </a>
                                    </div>
                                    <div class="p-3 ">
                                        <div class="flex items-center justify-between gap-2 mb-2">
                                            <h3 class="text-xl font-medium dark:text-gray-400">
                                                {{ str($item->name)->words(3) }}
                                            </h3>
                                        </div>
                                        <p class="text-lg ">
