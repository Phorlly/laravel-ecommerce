    ...
    <section class="overflow-hidden bg-white py-11 font-poppins dark:bg-gray-800">
        <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
            <div class="flex flex-wrap -mx-4">
                <div class="w-full mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: '{{ asset('storage/' . $model->images[0]) }}' }">
                    <div class="sticky top-0 z-50 overflow-hidden ">
                        <div class="relative mb-6 lg:mb-10 lg:h-2/4 ">
                            <img x-bind:src="mainImage" alt="{{ $model->images[0] }}"
                        ...
                        <div class="flex-wrap hidden md:flex ">
                            @foreach ($model->images as $image)
                                <div class="w-1/2 p-2 sm:w-1/4"
                                    ...
                                    <img src="{{ asset('storage/' . $image) }}" alt="{{ $model->name }}"
                                        class="object-cover w-full rounded-lg lg:h-20 cursor-pointer hover:border hover:border-blue-500">
                                </div>
                            @endforeach
                        </div>
                    ...
                    <div class="lg:pl-20">
                        <div class="mb-8 [&>ul]:list-disc [&>ul]:ml-4">
                            ...
                            <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                                <span>{{ Number::currency($model->price) }}</span>
                                {{-- <span
                                ...
                                <div class="relative flex flex-row w-full h-10 mt-6 bg-transparent rounded-lg">
                                    <button wire:click="decrease"
                                        ...
                                        <span class="text-2xl font-thin">
                                            <x-fas-minus class="m-auto w-4 h-4" />
                                        </span>
                                    </button>
                                    ...
                                    <button wire:click="increase"
                                        ...
                                        <span class="text-2xl font-thin">
                                            <x-fas-plus class="m-auto w-4 h-4" />
                                        </span>
                                    </button>
                                </div>
                        </div>
                        <div class="flex flex-wrap items-center gap-4">
                            <button wire:click='addToCart({{ $model->id }})'
                                class="w-full flex items-center p-4 bg-blue-500 rounded-md lg:w-2/5 dark:text-gray-200 text-gray-50 hover:bg-blue-600 dark:bg-blue-500 dark:hover:bg-blue-700">
                                <x-fas-cart-plus class="mx-4 w-4 h-4" />
