                ...
                <div class="p-4 sm:p-7">
                    ...
                    <div class="mt-5">
                        ...
                        <form wire:submit.prevent='modify'>
                            @if (session('error'))
                                <div class="my-4 bg-red-100 border border-red-200 text-sm text-red-800 rounded-lg p-4 dark:bg-red-800/10 dark:border-red-900 dark:text-red-500"
                            ...
                            <div class="grid gap-y-4">
                                ...
                                <button type="submit"
                                    class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-red-500 text-white hover:bg-red-600 disabled:opacity-50 disabled:pointer-events-none focus:bg-red-600 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                                    <span wire:loading.remove>Modify password</span>
                                    <span wire:loading>Modifying password...</span>
                                </button>
                            </div>
                        </form>
                        <!-- End Form -->
